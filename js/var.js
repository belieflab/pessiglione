...
let trainingA = [
  {stimulusLeft: trainStimA[0], stimulusRight: trainStimA[1], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[0], pair_validity: training_validity[0], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[0], reward_type: training_trial_type[0], correct_response: leftASCII}}, // 0 key
  {stimulusLeft: trainStimA[1], stimulusRight: trainStimA[0], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[0], pair_validity: training_validity[0], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[0], reward_type: training_trial_type[0], correct_response: rightASCII}}, // 0 key
  {stimulusLeft: trainStimA[2], stimulusRight: trainStimA[3], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[1], pair_validity: training_validity[1], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[1], reward_type: training_trial_type[1], correct_response: leftASCII}}, // 0 key
  {stimulusLeft: trainStimA[3], stimulusRight: trainStimA[2], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[1], pair_validity: training_validity[1], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[1], reward_type: training_trial_type[1], correct_response: rightASCII}}, // 0 key
  {stimulusLeft: trainStimA[4], stimulusRight: trainStimA[5], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[2], pair_validity: training_validity[2], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[2], reward_type: training_trial_type[2], correct_response: leftASCII}}, // 0 key
  {stimulusLeft: trainStimA[5], stimulusRight: trainStimA[4], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[2], pair_validity: training_validity[2], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[2], reward_type: training_trial_type[2], correct_response: rightASCII}}, // 0 key
  {stimulusLeft: trainStimA[6], stimulusRight: trainStimA[7], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[3], pair_validity: training_validity[3], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[3], reward_type: training_trial_type[3], correct_response: leftASCII}}, // 0 key
...
let trainingB = [
  {stimulusLeft: trainStimB[0], stimulusRight: trainStimB[1], chooseLeft: choiceB, chooseRight: choiceB, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[0], pair_validity: training_validity[0], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[0], reward_type: training_trial_type[0], correct_response: leftASCII}}, // 0 key
  {stimulusLeft: trainStimB[1], stimulusRight: trainStimB[0], chooseLeft: choiceB, chooseRight: choiceB, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[0], pair_validity: training_validity[0], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[0], reward_type: training_trial_type[0], correct_response: rightASCII}}, // 0 key
  {stimulusLeft: trainStimB[2], stimulusRight: trainStimB[3], chooseLeft: choiceB, chooseRight: choiceB, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[1], pair_validity: training_validity[1], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[1], reward_type: training_trial_type[1], correct_response: leftASCII}}, // 0 key
  {stimulusLeft: trainStimB[3], stimulusRight: trainStimB[2], chooseLeft: choiceB, chooseRight: choiceB, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[1], pair_validity: training_validity[1], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[1], reward_type: training_trial_type[1], correct_response: rightASCII}}, // 0 key
  {stimulusLeft: trainStimA[4], stimulusRight: trainStimA[5], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[2], pair_validity: training_validity[2], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[2], reward_type: training_trial_type[2], correct_response: leftASCII}}, // 0 key
  {stimulusLeft: trainStimA[5], stimulusRight: trainStimA[4], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[2], pair_validity: training_validity[2], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[2], reward_type: training_trial_type[2], correct_response: rightASCII}}, // 0 key
  {stimulusLeft: trainStimA[6], stimulusRight: trainStimA[7], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[3], pair_validity: training_validity[3], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[3], reward_type: training_trial_type[3], correct_response: leftASCII}}, // 0 key
  {stimulusLeft: trainStimA[7], stimulusRight: trainStimA[6], chooseLeft: choiceA, chooseRight: choiceA, fixation: fixationDot, trialFeedback: feedbackContainer, data: {test_part: 'training', pair: training_pairs[3], pair_validity: training_validity[3], pairTrialsPerBlock: training_pairsPerBlock, good_stim: training_good_stim[3], reward_type: training_trial_type[3], correct_response: rightASCII}}, // 0 key
